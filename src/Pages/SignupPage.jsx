    ...
    <img src="Side Image.png" alt="" />
      ...
      <div className="flex flex-1 items-center justify-center bg-white p-6 md:p-10">
        <div className="w-full max-w-sm sm:max-w-md">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-1">Create an account</h1>
          ...
          <form className="flex flex-col space-y-4">
            ...
            <button 
              type="button" 
              className="flex items-center justify-center p-3 border border-gray-300 bg-white text-gray-700 rounded-md hover:bg-gray-50 transition duration-150 ease-in-out mt-3"
            >
              <span className="text-xl font-bold text-red-600 mr-2">G</span> 
              Sign up with Google
            </button>
          </form>
